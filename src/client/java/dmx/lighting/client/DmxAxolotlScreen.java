...
import dmx.lighting.UpdateDmxAxolotlPayload;
...
/**
 * Compact editor for a DMX Axolotl.
 *
 * DMX Axolotles currently expose RGB and Dimmer channels only.
 */
public final class DmxAxolotlScreen
        extends Screen {
    ...
    private boolean saveConfiguration() {
        if (entry == null
            ...
            setError(
                    "Select a loaded DMX Axolotl first."
            );
        ...
        if (!ClientPlayNetworking.canSend(
            ...
            setError(
                    "DMX Axolotl packet is unavailable."
            );
