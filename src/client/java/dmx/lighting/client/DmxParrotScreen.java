...
import dmx.lighting.UpdateDmxParrotPayload;
 ...
 *
 * DMX parrots currently expose RGB and Dimmer channels only.
 */
public final class DmxParrotScreen
        extends Screen {
    ...
    private boolean saveConfiguration() {
        if (entry == null
            ...
            setError(
                    "Select a loaded DMX parrot first."
            );
        ...
        if (!ClientPlayNetworking.canSend(
            ...
            setError(
                    "DMX Parrot packet is unavailable."
            );
