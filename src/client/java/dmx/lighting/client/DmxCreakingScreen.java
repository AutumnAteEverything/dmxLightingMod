...
import dmx.lighting.UpdateDmxCreakingPayload;
 ...
 *
 * DMX Creakings currently expose RGB and Dimmer channels only.
 */
public final class DmxCreakingScreen
        extends Screen {
    ...
    private boolean saveConfiguration() {
        if (entry == null
            ...
            setError(
                    "Select a loaded DMX Creaking first."
            );
        ...
        if (!ClientPlayNetworking.canSend(
            ...
            setError(
                    "DMX Creaking packet is unavailable."
            );
