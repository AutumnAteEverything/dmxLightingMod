...
import dmx.lighting.UpdateDmxWardenPayload;
 ...
 *
 * DMX Wardens currently expose RGB and Dimmer channels only.
 */
public final class DmxWardenScreen
        extends Screen {
    ...
    private boolean saveConfiguration() {
        if (entry == null
            ...
            setError(
                    "Select a loaded DMX Warden first."
            );
        ...
        if (!ClientPlayNetworking.canSend(
            ...
            setError(
                    "DMX Warden packet is unavailable."
            );
