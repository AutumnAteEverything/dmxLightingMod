...
import dmx.lighting.UpdateDmxNautilusPayload;
...
/**
 * Compact editor for a DMX Nautilus.
 *
 * DMX Nautiluses currently expose RGB and Dimmer channels only.
 */
public final class DmxNautilusScreen
        extends Screen {
    ...
    private boolean saveConfiguration() {
        if (entry == null
            ...
            setError(
                    "Select a loaded DMX Nautilus first."
            );
        ...
        if (!ClientPlayNetworking.canSend(
            ...
            setError(
                    "DMX Nautilus packet is unavailable."
            );
