...
| Disco ball | `DmxDiscoBallBlock`, `DmxDiscoBallBlockEntity`, `DiscoBallFixtureRenderer` | Two-channel dimmer and bipolar spin fixture with twenty-beam and surface-projected dot modes |
